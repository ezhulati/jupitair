document.addEventListener("DOMContentLoaded",()=>{document.querySelectorAll('.premium-card[data-variant="premium"], .premium-card[data-variant="interactive"]').forEach(e=>{let r;function o(n){const c=n.clientX,m=n.clientY,s=c-r.x,a=m-r.y,i={x:s-r.width/2,y:a-r.height/2};e.style.transform=`
          perspective(1000px)
          rotateX(${i.y/20}deg)
          rotateY(${-i.x/20}deg)
